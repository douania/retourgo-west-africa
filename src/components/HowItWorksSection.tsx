  ...
  const steps = [
    {
      ...
      descriptionKey: "how_it_works.step1_description",
      icon: (
        <svg
    ...
    },
    {
      ...
      descriptionKey: "how_it_works.step2_description",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      ...
      descriptionKey: "how_it_works.step3_description",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      ...
      descriptionKey: "how_it_works.step4_description",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    },
    {
      ...
      descriptionKey: "how_it_works.step5_description",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="text-base font-semibold leading-7 text-retourgo-orange">
            {t("how_it_works.process_title")}
          </h2>
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            {t("how_it_works.subtitle")}
          </p>
          <p className="mt-6 text-lg leading-8 text-gray-600">
            {t("how_it_works.process_subtitle")}
          </p>
        </div>
